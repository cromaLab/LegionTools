#docker build -t leg .
#docker run -d -p 2345:80 leg /usr/sbin/apache2ctl -D FOREGROUND
...
# Skipping: mysql-server php5-mysql

# REMOVE LATER: Developer stuff
...
# Keys were created with openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout /etc/apache2/ssl/apache.key -out /etc/apache2/ssl/apache.crt
