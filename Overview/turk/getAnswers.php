...
if(isset($_REQUEST['mode']) && $_REQUEST['mode'] == "retainer" || $_REQUEST['mode'] == "auto"){
    ...
    if($_REQUEST['mode'] == "auto") { 
        ...
        $url = $baseURL . "/Retainer/index.php?task=" . $_REQUEST['task'] . "&amp;&amp;requireUniqueWorkers=" . $_REQUEST['requireUniqueWorkers'] . "&amp;&amp;dbName=" . $tableName . "&amp;&amp;tutPageUrl=" . urlencode($_REQUEST['tutPageUrl']) . "&amp;&amp;waitPageUrl=" . urlencode($_REQUEST['waitPageUrl']) . "&amp;&amp;instrPageUrl=" . urlencode($_REQUEST['instrPageUrl']); 
    }
